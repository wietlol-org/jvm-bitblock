...
object BitModuleSerializer : ModelSerializer<BitModule, BitModule>
{
	...
	private val moduleIndex: Int = 1
	
	private val ownerIndex: Int = 2
	
	private val versionIndex: Int = 3
	
	private val apiRootPackageIndex: Int = 4
	
	private val implRootPackageIndex: Int = 5
	
	private val builderPackageIndex: Int = 6
	
	private val apiModelPackageIndex: Int = 7
	
	private val implModelPackageIndex: Int = 8
	
	private val serializerPackageIndex: Int = 9
	
	private val annotationsIndex: Int = 10
	
	private val modelsIndex: Int = 11
	
	private val relativeRootIndex: Int = 12
	
	private val relativeApiRootIndex: Int = 13
	
	private val relativeImplRootIndex: Int = 14
	
	private val useExistingModelsIndex: Int = 15
	
	private val builderFacadeIndex: Int = 16
	
	private val mutableModelNameFormatIndex: Int = 17
	
	private val implementationNameFormatIndex: Int = 18
